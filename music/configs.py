...
# This file contains configurations for the MusicVAE models which is a part of the Magenta project.
# MusicVAE is a Variational Autoencoder for music generation **and is pre-existing work not associated with the authors**.
...
from magenta.models.music_vae import data #import data
...
CONFIG_MAP['hierdec-mel_16bar'] = Config(
    ...
    note_sequence_augmenter=None,
    data_converter=mel_16bar_converter,
    train_examples_path="nlbvalidate.tfrecord",
    eval_examples_path=None,
)
